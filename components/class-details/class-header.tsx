...
export function ClassHeader() {
  const handleShare = async () => {
    const shareData = {
      title: 'Power Yoga — Align with Enjy',
      text: 'Join me for Power Yoga at Align with Enjy! Sunday at 11:00 AM',
  ...
  return (
    <div className="bg-gradient-to-r from-[#006D77] to-[#E86500] h-52 relative flex items-center justify-center">
