    ...
    <div className="-mt-8 relative z-10">
      <div className="bg-white rounded-2xl p-5 shadow-lg border border-border">
        ...
        <div className="flex flex-wrap gap-2 mb-5">
          <div className="flex items-center gap-2 bg-[#F8BBD0]/30 rounded-full py-2 px-3">
          ...
          <div className="flex items-center gap-2 bg-[#F8BBD0]/30 rounded-full py-2 px-3">
            <Zap className="w-3.5 h-3.5 text-[#D63384]" />
            <span className="text-xs font-medium text-foreground">60 min</span>
          </div>
          <div className="flex items-center gap-2 bg-[#F8BBD0]/30 rounded-full py-2 px-3">
            <BarChart3 className="w-3.5 h-3.5 text-[#D63384]" />
            <span className="text-xs font-medium text-foreground">All Levels</span>
          </div>
        </div>

        <div className="flex items-center gap-3 pt-4 border-t border-border">
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#D63384] to-[#7B2D8E] flex items-center justify-center text-white font-bold text-sm">
            EG
          </div>
          <div>
