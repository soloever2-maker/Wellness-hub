    ...
    <div className="-mt-8 relative z-10">
      <div className="bg-white rounded-2xl p-5 shadow-lg border border-border">
        ...
        <div className="flex flex-wrap gap-2 mb-5">
          <div className="flex items-center gap-2 bg-[#FFD9B8]/30 rounded-full py-2 px-3">
        ...
        <div className="flex items-center gap-3 pt-4 border-t border-border">
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#006D77] to-[#E86500] flex items-center justify-center text-white font-bold text-sm">
            EG
          </div>
          <div>
