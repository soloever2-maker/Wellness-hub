...
export function Hero() {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-[#D63384] to-[#7B2D8E] px-4 py-20 flex flex-col justify-center items-center text-center overflow-hidden">
      {/* Decorative circles */}
