...
export function TodaysClasses() {
  return (
    <div>
      <h3 className="text-lg font-semibold text-foreground mb-3">Today&apos;s Classes</h3>
      <div className="flex gap-3 overflow-x-auto pb-2 -mx-4 px-4 scrollbar-hide">
        {todaysClasses.map((cls) => (
          <div
            key={cls.id}
            className="flex-shrink-0 bg-white border border-border rounded-2xl p-4 w-40 shadow-sm hover:shadow-md transition-shadow cursor-pointer"
          >
